...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar a qué país pertenece un atleta");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	private void ejercutarPaisSegunAtleta()
	{
		System.out.println("\n" + "A que país representa un atleta" + "\n");
		
		String pregunta = input("Atleta que desea consultar");
		
		
		String resultado = calculadora.PaisPerteneciente(pregunta);
		
		if (resultado.equals("Atleta no encontrado."))
		{
